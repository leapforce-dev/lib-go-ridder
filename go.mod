...
require (
	...
	github.com/leapforce-libraries/go_http v0.0.0-20250227233108-845165e1bbff
	github.com/leapforce-libraries/go_utilities v0.0.0-20250122190726-16b1db512d11
)
